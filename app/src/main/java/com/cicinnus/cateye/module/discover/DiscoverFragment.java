...
public class DiscoverFragment extends BaseMVPFragment<DiscoverPresenter>
    implements DiscoverContract.IDiscoverView {
   ...
   protected void initEventAndData() {
      ...
      // RV头部栏目
      headerView = mContext.getLayoutInflater()
          .inflate(R.layout.item_discover_header, (ViewGroup) rvDiscover.getParent(), false);
